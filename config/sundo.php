...
return [
    ...
    */
    'youtube' => [
        'bin_dir' => env('YOUTUBE_BIN_DIR', '/var/www/html/bin'),
        ...
        'yt_dlp_path' => env('YOUTUBE_YT_DLP_PATH', '/var/www/html/bin/yt-dlp'),
        'ffmpeg_path' => env('YOUTUBE_FFMPEG_PATH', '/var/www/html/bin/ffmpeg'),
        'cookies_path' => env('YOUTUBE_COOKIES_PATH') ?: storage_path('app/cookies.txt'),
        'bun_path' => env('BUN_PATH', '/var/www/html/bin/bun'),
    ],
