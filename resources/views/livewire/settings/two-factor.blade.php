    ...
    >
        <div class="space-y-6">
                <div class="flex flex-col items-center gap-4">
                    <div class="p-0.5 w-auto rounded-full border border-zinc-100 dark:border-zinc-600 bg-white dark:bg-zinc-800 shadow-sm transition-all duration-200">
            ...
            @else
                ...
                <div class="flex justify-center">
                    <div class="relative w-64 overflow-hidden border rounded-lg border-zinc-200 dark:border-zinc-700 aspect-square transition-all duration-200">
                        @empty($qrCodeSvg)
